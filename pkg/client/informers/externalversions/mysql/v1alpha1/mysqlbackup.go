...
import (
	mysqlv1alpha1 "mysql-infomer/pkg/apis/mysql/v1alpha1"
	versioned "mysql-infomer/pkg/client/clientset/versioned"
	internalinterfaces "mysql-infomer/pkg/client/informers/externalversions/internalinterfaces"
	v1alpha1 "mysql-infomer/pkg/client/listers/mysql/v1alpha1"
	time "time"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.PaasV1alpha1().MysqlBackups(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.PaasV1alpha1().MysqlBackups(namespace).Watch(options)
			},
		},
