...
type FakeMysqlBackups struct {
	Fake *FakePaasV1alpha1
	ns   string
}

var mysqlbackupsResource = schema.GroupVersionResource{Group: "paas.fit2cloud.com", Version: "v1alpha1", Resource: "mysqlbackups"}

var mysqlbackupsKind = schema.GroupVersionKind{Group: "paas.fit2cloud.com", Version: "v1alpha1", Kind: "MysqlBackup"}
